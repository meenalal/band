$(document).ready(function() {
   ...
   var backgrounds = new Array(
       'url(assets/images/foxtheater.jpg)'
     , 'url(assets/images/673329.jpg)'
     , 'url(assets/images/calatrava.jpg)'
     , 'url(assets/images/fox_inside.jpg)'
     , 'url(assets/images/Hollywood-Bowl-Fireworks.jpg)'
     , 'url(assets/images/jsdgfvadshg.jpg)'
     , 'url(assets/images/nyc.jpg)'
     , 'url(assets/images/orange.jpg)'
     , 'url(assets/images/spikey.jpg)'
     , 'url(assets/images/stage.jpg)'
     , 'url(assets/images/timessquare.jpg)'
   );
   ...
   function nextBackground() {
       ...
       header.css('background-width', '100%');
